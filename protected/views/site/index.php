...
<h1 style="text-align: center;font-size: 60px"> <img alt="logo"  src="<?php echo Yii::app()->request->baseUrl?>/images/logo.jpg" width="150px"><br/>Bienvenidos !!!!! </h1>
...
<h3>"Se puede programar/competir con cualquier lenguaje" java, python, php, c, c++, pascal, javascript, c#, ciao-prolog, visual basic, perl, bash, lisp, ruby, smalltalk ..... cualquier lenguaje.
</h3>
