...
<body>
	...
	<div id="header">
            <div id="logo"><!--<img alt="logo" src="<?php echo Yii::app()->request->baseUrl?>/images/logo.jpg" width="40px"></img>--><?php echo CHtml::encode($this->pageTitle); ?></div>
	</div><!-- header -->
